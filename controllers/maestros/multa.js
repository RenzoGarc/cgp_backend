import { MultaService } from "../../services/maestros/multa.js";
...
export class MultaController {
  ...
  getById = async (req, res) => {
    const { id } = req.params;
    try {
      const data = await multaService.getById(id);
  ...
  create = async (req, res) => {
    ...
    try {
      const data = await multaService.create(estado);
  ...
  delete = async (req, res) => {
    ...
    try {
      const data = await multaService.delete(id);
  ...
  update = async (req, res) => {
    ...
    const { estado } = req.body;
    try {
      const data = await multaService.update(id, estado);
