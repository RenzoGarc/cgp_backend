import { SancionService } from "../../services/maestros/sancion.js";

const sancionService = new SancionService();
...
export class SancionController {
  ...
  async getAll(req, res) {
    try {
      const data = await sancionService.getAll();
      res.json(data);
    } catch (error) {
  ...
  getById = async (req, res) => {
    const { id } = req.params;
    try {
      const data = await sancionService.getById(id);
  ...
  create = async (req, res) => {
    ...
    try {
      const data = await sancionService.create(estado);
  ...
  delete = async (req, res) => {
    ...
    try {
      const data = await sancionService.delete(id);
  ...
  update = async (req, res) => {
    ...
    const { estado } = req.body;
    try {
      const data = await sancionService.update(id, estado);
