import { ConfigurationsService } from "../../services/maestros/configurations.js";
...
export class ConfigurationsController {
  ...
  async getAll(req, res) {
    try {
      const data = await configurationsService.getAll();
      res.json(data);
    } catch (error) {
  ...
  getById = async (req, res) => {
    const { id } = req.params;
    try {
      const data = await configurationsService.getById(id);
  ...
  create = async (req, res) => {
    ...
    try {
      const data = await configurationsService.create(estado);
  ...
  delete = async (req, res) => {
    ...
    try {
      const data = await configurationsService.delete(id);
  ...
  update = async (req, res) => {
    ...
    const { estado } = req.body;
    try {
      const data = await configurationsService.update(id, estado);
